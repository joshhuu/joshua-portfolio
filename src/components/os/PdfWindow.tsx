...
export function PdfWindow({ isOpen, onClose, pdfUrl, title = "Joshua-Resume-2026.pdf" }: PdfWindowProps) {
  ...
  const windowVariants = {
    ...
    exit: (custom: "close" | "minimize") => 
      custom === "minimize" 
        ? { scale: 0.4, y: "100vh", opacity: 0, transition: { duration: 0.4, ease: [0.16, 1, 0.3, 1] as [number, number, number, number] } }
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2 group/lights">
                  ...
                  >
                     <span className="opacity-0 group-hover/lights:opacity-100 text-[9px] text-[#990000] font-bold leading-none mb-[1px]">x</span>
                  </button>
                  <button 
                    onClick={(e) => { 
                      e.stopPropagation(); 
                  ...
                  >
                    <span className="opacity-0 group-hover/lights:opacity-100 text-[10px] text-[#995700] font-bold leading-none mb-[1px]">-</span>
                  </button>
                  <button 
                    onClick={(e) => { 
                      e.stopPropagation(); 
                  ...
                  >
                    <span className="opacity-0 group-hover/lights:opacity-100 text-[10px] text-[#006500] font-bold leading-none mb-[1px]">+</span>
                  </button>
                </div>
